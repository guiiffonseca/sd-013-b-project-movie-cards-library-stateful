...
import MovieRating from './AddMoviesubComponents/MovieRating';
import MovieGenre from './AddMoviesubComponents/MovieGenre';
import AddMovieBtn from './AddMoviesubComponents/AddMovieBtn';
  ...
  render() {
    ...
    return (
      <form data-testid="add-movie-form">
        ...
        <MovieRating value={ rating } callBack={ this.handleChange } />
        <MovieGenre value={ genre } callBack={ this.handleChange } />
        <AddMovieBtn onClick={ this.handleSubmit } />
      </form>
    );
  }
}
